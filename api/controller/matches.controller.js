  ...
  try {
    ...
    const users = await User.find({
      $and: [
        ...
        { _id: { $nin: currentUser.likes } }, // Exclude already liked  users
        { _id: { $nin: currentUser.dislikes } }, // Exclude already  disliked users
        { _id: { $nin: currentUser.matches } }, // Exclude already matches users
        {
          gender:
